...
void ExecutionEngine::inicializaInstrucoes() {
	...
	vetorDePonteirosParaFuncao[0x00] = &ExecutionEngine::java_nop; //Nao faz nada e incrementa PC
	vetorDePonteirosParaFuncao[0x01] = &ExecutionEngine::java_aconst_null; //Empilha Null 
	vetorDePonteirosParaFuncao[0x02] = &ExecutionEngine::java_iconst_m1; //Empilha a constante int -1
	vetorDePonteirosParaFuncao[0x03] = &ExecutionEngine::java_iconst_0; //Empilha a constante int 0
	vetorDePonteirosParaFuncao[0x04] = &ExecutionEngine::java_iconst_1; //Empilha a constante int 1
	vetorDePonteirosParaFuncao[0x05] = &ExecutionEngine::java_iconst_2; //Empilha a constante int 2
	vetorDePonteirosParaFuncao[0x06] = &ExecutionEngine::java_iconst_3; //Empilha a constante int 3
	vetorDePonteirosParaFuncao[0x07] = &ExecutionEngine::java_iconst_4; //Empilha a constante int 4
	vetorDePonteirosParaFuncao[0x08] = &ExecutionEngine::java_iconst_5; //Empilha a constante int 5
	vetorDePonteirosParaFuncao[0x09] = &ExecutionEngine::java_lconst_0; //Empilha a constante long 0
	vetorDePonteirosParaFuncao[0x0a] = &ExecutionEngine::java_lconst_1; //Empilha a constante long 1
	vetorDePonteirosParaFuncao[0x0b] = &ExecutionEngine::java_fconst_0; //Empilha a constante float 0.0
	vetorDePonteirosParaFuncao[0x0c] = &ExecutionEngine::java_fconst_1; //Empilha a constante float 1.0
	vetorDePonteirosParaFuncao[0x0d] = &ExecutionEngine::java_fconst_2; //Empilha a constante float 2.0
	vetorDePonteirosParaFuncao[0x0e] = &ExecutionEngine::java_dconst_0; //Empilha a constante double 0.0
	vetorDePonteirosParaFuncao[0x0f] = &ExecutionEngine::java_dconst_1; //Empilha a constante long 1.0
	vetorDePonteirosParaFuncao[0x10] = &ExecutionEngine::java_bipush; //Empilha um byte
	vetorDePonteirosParaFuncao[0x11] = &ExecutionEngine::java_sipush; //Empilha um short
	vetorDePonteirosParaFuncao[0x12] = &ExecutionEngine::java_ldc; //Empilha item da constant pool
	vetorDePonteirosParaFuncao[0x13] = &ExecutionEngine::java_ldc_w; //Empilha item da constant pool com Wide Index
	vetorDePonteirosParaFuncao[0x14] = &ExecutionEngine::java_ldc2_w; //Empilha long ou double da constant pool com Wide Index
	vetorDePonteirosParaFuncao[0x15] = &ExecutionEngine::java_iload; //Carrega int da variavel local
	vetorDePonteirosParaFuncao[0x16] = &ExecutionEngine::java_lload; //Carrega load da variavel local
	vetorDePonteirosParaFuncao[0x17] = &ExecutionEngine::java_fload; //Carrega float da variavel local
	vetorDePonteirosParaFuncao[0x18] = &ExecutionEngine::java_dload; //Carrega double da variavel local
	vetorDePonteirosParaFuncao[0x19] = &ExecutionEngine::java_aload; //Carrega referencia da variavel local
	vetorDePonteirosParaFuncao[0x1a] = &ExecutionEngine::java_iload_0; //Carrega int da variavel local em 0
	vetorDePonteirosParaFuncao[0x1b] = &ExecutionEngine::java_iload_1; //Carrega int da variavel local em 1
	vetorDePonteirosParaFuncao[0x1c] = &ExecutionEngine::java_iload_2; //Carrega int da variavel local em 2
	vetorDePonteirosParaFuncao[0x1d] = &ExecutionEngine::java_iload_3; //Carrega int da variavel local em 3
	vetorDePonteirosParaFuncao[0x1e] = &ExecutionEngine::java_lload_0; //Carrega load da variavel local em 0
	vetorDePonteirosParaFuncao[0x1f] = &ExecutionEngine::java_lload_1; //Carrega load da variavel local em 1
	vetorDePonteirosParaFuncao[0x20] = &ExecutionEngine::java_lload_2; //Carrega load da variavel local em 2
	vetorDePonteirosParaFuncao[0x21] = &ExecutionEngine::java_lload_3; //Carrega load da variavel local em 3
	vetorDePonteirosParaFuncao[0x22] = &ExecutionEngine::java_fload_0; //Carrega float da variavel local em 0
	vetorDePonteirosParaFuncao[0x23] = &ExecutionEngine::java_fload_1; //Carrega float da variavel local em 1
	vetorDePonteirosParaFuncao[0x24] = &ExecutionEngine::java_fload_2; //Carrega float da variavel local em 2
	vetorDePonteirosParaFuncao[0x25] = &ExecutionEngine::java_fload_3; //Carrega float da variavel local em 3
	vetorDePonteirosParaFuncao[0x26] = &ExecutionEngine::java_dload_0; //Carrega double da variavel local em 0
	vetorDePonteirosParaFuncao[0x27] = &ExecutionEngine::java_dload_1; //Carrega double da variavel local em 1
	vetorDePonteirosParaFuncao[0x28] = &ExecutionEngine::java_dload_2; //Carrega double da variavel local em 2
	vetorDePonteirosParaFuncao[0x29] = &ExecutionEngine::java_dload_3; //Carrega double da variavel local em 3
	vetorDePonteirosParaFuncao[0x2a] = &ExecutionEngine::java_aload_0; //Carrega referencia da variavel local em 0
	vetorDePonteirosParaFuncao[0x2b] = &ExecutionEngine::java_aload_1; //Carrega referencia da variavel local em 1
	vetorDePonteirosParaFuncao[0x2c] = &ExecutionEngine::java_aload_2; //Carrega referencia da variavel local em 2
	vetorDePonteirosParaFuncao[0x2d] = &ExecutionEngine::java_aload_3; //Carrega referencia da variavel local em 3
	vetorDePonteirosParaFuncao[0x2e] = &ExecutionEngine::java_iaload; //Carrega int de um array
	vetorDePonteirosParaFuncao[0x2f] = &ExecutionEngine::java_laload; //Carrega load de um array
	vetorDePonteirosParaFuncao[0x30] = &ExecutionEngine::java_faload; //Carrega float de um array
	vetorDePonteirosParaFuncao[0x31] = &ExecutionEngine::java_daload; //Carrega double de um array
	vetorDePonteirosParaFuncao[0x32] = &ExecutionEngine::java_aaload; //Carrega referencia de um array
	vetorDePonteirosParaFuncao[0x33] = &ExecutionEngine::java_baload; //Carrega byte ou boolean de um array
	vetorDePonteirosParaFuncao[0x34] = &ExecutionEngine::java_caload; //Carrega char de um array
	vetorDePonteirosParaFuncao[0x35] = &ExecutionEngine::java_saload; //Carrega string de um array
	vetorDePonteirosParaFuncao[0x36] = &ExecutionEngine::java_istore; //Armazena int na variavel local
	vetorDePonteirosParaFuncao[0x37] = &ExecutionEngine::java_lstore; //Armazena load na variavel local
	vetorDePonteirosParaFuncao[0x38] = &ExecutionEngine::java_fstore; //Armazena float na variavel local
	vetorDePonteirosParaFuncao[0x39] = &ExecutionEngine::java_dstore; //Armazena double na variavel local
	vetorDePonteirosParaFuncao[0x3a] = &ExecutionEngine::java_astore; //Armazena referencia na variavel local
	vetorDePonteirosParaFuncao[0x3b] = &ExecutionEngine::java_istore_0; //Armazena int na variavel local 0
	vetorDePonteirosParaFuncao[0x3c] = &ExecutionEngine::java_istore_1; //Armazena int na variavel local 1
	vetorDePonteirosParaFuncao[0x3d] = &ExecutionEngine::java_istore_2; //Armazena int na variavel local 2
	vetorDePonteirosParaFuncao[0x3e] = &ExecutionEngine::java_istore_3; //Armazena int na variavel local 3
	vetorDePonteirosParaFuncao[0x3f] = &ExecutionEngine::java_lstore_0; //Armazena long na variavel local 0
	vetorDePonteirosParaFuncao[0x40] = &ExecutionEngine::java_lstore_1; //Armazena long na variavel local 1
	vetorDePonteirosParaFuncao[0x41] = &ExecutionEngine::java_lstore_2; //Armazena long na variavel local 2
	vetorDePonteirosParaFuncao[0x42] = &ExecutionEngine::java_lstore_3; //Armazena long na variavel local 3
	vetorDePonteirosParaFuncao[0x43] = &ExecutionEngine::java_fstore_0; //Armazena float na variavel local 0
	vetorDePonteirosParaFuncao[0x44] = &ExecutionEngine::java_fstore_1; //Armazena float na variavel local 1
	vetorDePonteirosParaFuncao[0x45] = &ExecutionEngine::java_fstore_2; //Armazena float na variavel local 2
	vetorDePonteirosParaFuncao[0x46] = &ExecutionEngine::java_fstore_3; //Armazena float na variavel local 3
	vetorDePonteirosParaFuncao[0x47] = &ExecutionEngine::java_dstore_0; //Armazena double na variavel local 0
	vetorDePonteirosParaFuncao[0x48] = &ExecutionEngine::java_dstore_1; //Armazena double na variavel local 1
	vetorDePonteirosParaFuncao[0x49] = &ExecutionEngine::java_dstore_2; //Armazena double na variavel local 2
	vetorDePonteirosParaFuncao[0x4a] = &ExecutionEngine::java_dstore_3; //Armazena double na variavel local 3
	vetorDePonteirosParaFuncao[0x4b] = &ExecutionEngine::java_astore_0; //Armazena referencia na variavel local 0
	vetorDePonteirosParaFuncao[0x4c] = &ExecutionEngine::java_astore_1; //Armazena referencia na variavel local 1
	vetorDePonteirosParaFuncao[0x4d] = &ExecutionEngine::java_astore_2; //Armazena referencia na variavel local 2
	vetorDePonteirosParaFuncao[0x4e] = &ExecutionEngine::java_astore_3; //Armazena referencia na variavel local 3
	vetorDePonteirosParaFuncao[0x4f] = &ExecutionEngine::java_iastore; //Armazena em uma array de int
	vetorDePonteirosParaFuncao[0x50] = &ExecutionEngine::java_lastore; //Armazena em uma array de long
	vetorDePonteirosParaFuncao[0x51] = &ExecutionEngine::java_fastore; //Armazena em uma array de float
	vetorDePonteirosParaFuncao[0x52] = &ExecutionEngine::java_dastore; //Armazena em uma array de double
	vetorDePonteirosParaFuncao[0x53] = &ExecutionEngine::java_aastore; //Armazena em uma array de referencia
	vetorDePonteirosParaFuncao[0x54] = &ExecutionEngine::java_bastore; //Armazena em uma array de byte ou boolean
	vetorDePonteirosParaFuncao[0x55] = &ExecutionEngine::java_castore; //Armazena em uma array de char 
	vetorDePonteirosParaFuncao[0x56] = &ExecutionEngine::java_sastore; //Armazena em uma array de string
	vetorDePonteirosParaFuncao[0x57] = &ExecutionEngine::java_pop; //Retira o valor do topo da pilha de operandos
	vetorDePonteirosParaFuncao[0x58] = &ExecutionEngine::java_pop2; //Retira os primeiros 1 ou 2 valores do topo da pilha de operandos 
	vetorDePonteirosParaFuncao[0x59] = &ExecutionEngine::java_dup; //Duplica o topo da pilha de operandos
	vetorDePonteirosParaFuncao[0x5a] = &ExecutionEngine::java_dup_x1; //Duplica o topo da pilha e coloca 2 valores abaixo
	vetorDePonteirosParaFuncao[0x5b] = &ExecutionEngine::java_dup_x2; //Duplica o topo da pilha e coloca 2, 3 ou 4 valores abaixo
	vetorDePonteirosParaFuncao[0x5c] = &ExecutionEngine::java_dup2; //Duplica os dois primeiros valores da pilha
	vetorDePonteirosParaFuncao[0x5d] = &ExecutionEngine::java_dup2_x1; //Duplica os dois primeiros valores da pilha e coloca 2 valores abaixo
	vetorDePonteirosParaFuncao[0x5e] = &ExecutionEngine::java_dup2_x2; //Duplica os dois primeiros valores da pilha e coloca 2, 3 ou 4 valores abaixo
